<aside class="sidenav bg-dark navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 "
    ...
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href="{{ route('home') }}"
            ...
            <span class="ms-1 font-weight-bold text-white">ARSIP SURAT RESMI</span>
        </a>
    </div>
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link {{ Route::currentRouteName() == 'arsip' ? 'active' : '' }}" href="{{ route('arsip') }}">
                    ...
                    <span class="nav-link-text ms-1 text-white">Arsip Surat</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ Route::currentRouteName() == 'kategori' ? 'active' : '' }}" href="{{ route('kategori') }}">
                    ...
                    <span class="nav-link-text ms-1 text-white">Kategori Surat</span>
                </a>
            </li>
            <li class="nav-item">
