                ...
                <div class="card">
                    <div class="card-body p-3">
                        <div class="row">
                            <div class="col-8">
                                <div class="numbers">
                                    <a class="text-sm mb-0 text-uppercase font-weight-bold" href="{{ route('arsip') }}">Arsip Surat</a>
                ...
                <div class="card">
                    <div class="card-body p-3">
                        <div class="row">
                            <div class="col-8">
                                <div class="numbers">
                                    <a class="text-sm mb-0 text-uppercase font-weight-bold" href="{{ route('kategori') }}">Kategori Surat</a>
                                    <h5 class="font-weight-bolder">
                                        {{ $jumlahKategori }}
                                    </h5>
                                </div>
